...
//			Toast.makeText( this, error, Toast.LENGTH_LONG ).show();
	...
	private class HDAsyncTask extends AsyncTask<Cursor, Integer, String> {
		...
		protected void onPostExecute( String errorString ) {
			...
			if ( null != errorString ) {
//				Toast.makeText( AviaryActivity.this, "There was an error: " + errorString, Toast.LENGTH_SHORT ).show();
				return;
			}
...
//				Toast.makeText( AviaryActivity.this, "Failed to load image " + mUri, Toast.LENGTH_SHORT ).show();
			}
		}
