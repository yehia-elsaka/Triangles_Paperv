...
public class LikesActivity extends Fragment implements OnClickListener, OnItemClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		lstVideos = StoryList.getVideoList();

		listView.setAdapter(new LikesAdapter(getActivity(), lstVideos, this));
...
//		});
	...
	public void onItemClick(AdapterView<?> adp, View arg1, int position, long arg3) {
		...
		if (adp != null && adp.getAdapter() instanceof LikesAdapter) {
			LikesAdapter swipeAdp = (LikesAdapter) adp.getAdapter();
			StoryItem itm = swipeAdp.getItem(position);
