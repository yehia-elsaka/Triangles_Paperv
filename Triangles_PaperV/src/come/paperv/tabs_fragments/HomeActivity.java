...
import come.paperv.tabs_adapters.HomeAdapter;
...
//		getCurrentStories();
		...
		homeAdapter = new HomeAdapter(getActivity(), currentStories);
	...
	public void onItemClick(AdapterView<?> adp, View listview, int position,
		...
		if (adp != null && adp.getAdapter() instanceof HomeAdapter) {
			HomeAdapter newsAdp = (HomeAdapter) adp.getAdapter();
