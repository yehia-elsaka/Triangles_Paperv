...
import come.paperv.tabs_adapters.ExploreAdapter;
...
public class ExploreActivity extends Fragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		LinearLayout theLayout = (LinearLayout) inflater.inflate(
				R.layout.activity_explore, container, false);
		...
		lstStories = globalState.explore_list;
//		getCurrentStories();
		...
		exploreAdapter = new ExploreAdapter(getActivity(), currentStories);
	...
	public void onItemClick(AdapterView<?> adp, View listview, int position,
		...
		if (adp != null && adp.getAdapter() instanceof ExploreAdapter) {
			ExploreAdapter newsAdp = (ExploreAdapter) adp.getAdapter();
