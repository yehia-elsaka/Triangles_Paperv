...
$query = "select * from phpfox_like WHERE item_id = $item_id AND user_id = $user_id"; 
$data = mysql_query($query);
$row = mysql_fetch_array( $data );
$user = $row['user_id'];
if($user != '')
{
$response[] = array('success'=>false, 'msg'=> 'User already like this story!' );
}
...
$query = "UPDATE phpfox_story SET total_like = total_like + 1 WHERE story_id = $item_id"; 
$result = mysql_query($query);
